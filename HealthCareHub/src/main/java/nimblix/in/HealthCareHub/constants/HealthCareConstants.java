...
public class HealthCareConstants {
    ...
    public static String PATIENT_ACTIVATED_SUCCESSFULLY="Patient Activated Successfully";
    public static String DOCTOR_ACTIVATED_SUCCESSFULLY="Doctor activated successfully";
    public static String DOCTOR_ACTIVATION_FAILED="Doctor activation failed";
    public static String PATIENT_ACTIVATION_FAILED="Patient Activation failed";
