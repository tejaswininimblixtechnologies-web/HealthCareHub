...
public interface PatientService {
    ...
    MedicalRecordResponse updateDiagnosis(
            Long appointmentId,
            String diagnosis);

    MedicalRecordResponse addTreatment(
            Long appointmentId,
            String treatment);

    MedicalRecordResponse addClinicalNotes(
            Long appointmentId,
            String notes);

    List<MedicalRecordResponse> getMedicalTimeline(
            Long patientId);
}