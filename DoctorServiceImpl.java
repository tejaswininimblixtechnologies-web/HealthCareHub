...
//    }
    ...
    @Override
    public ResponseEntity<?> updateDoctor(Long doctorId, Doctor request) {

        Doctor doctor = doctorRepository.findById(doctorId)
                .orElseThrow(() -> new RuntimeException("Doctor not found"));

        // Email duplicate check
        if (!doctor.getEmailId().equals(request.getEmailId()) &&
                doctorRepository.findByEmailId(request.getEmailId()).isPresent()) {
